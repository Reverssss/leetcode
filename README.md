...
|       101        |         对称二叉树         |                     SymmetricTree                      |        二叉树        |                                        简单                                         |
...
|       861        |       翻转矩阵后的得分        |                ScoreAfterFlippingMatrix                |        位运算        |
|       876        |        链表的中间结点        |                 MiddleOfTheLinkedList                  |       快慢双指针       |
|       967        |       连续差相同的数字        |         NumbersWithSameConsecutiveDifferences          |      广度优先搜索       |
...
|1027|最长等差数列|LongestArithmeticSubsequence|
...
|       1791       |      找出星型图的中心节点       |                 FindCenterOfStarGraph                  |        桶排         |                                        简单                                         |
|       1792       |        最大平均通过率        |                MaximumAveragePassRatio                 | 小根堆PriorityQueue  |                                      比变化量大小                                       |
|       1807       |      替换字符串中的括号内容      |            EvaluateTheBracketPairsOfAString            |        哈希表        |
|       1817       |       查找用户活跃分钟数       |              FindingTheUsersActiveMinutes              |
|       1913       |     两个数对之间的最大乘积差      |        MaximumProductDifferenceBetweenTwoPairs         |
|       1979       |      找出数组的最大公约数       |            FindGreatestCommonDivisorOfArray            |
|       1984       |       学生分数的最小差值       |   MinimumDifferenceBetweenHighestAndLowestOfKScores    |    模拟,先排序再找最值     |                                        简单                                         |
|       1991       |       找到数组的中间位置       |               FindTheMiddleIndexInArray                |        前缀和        |               
|       1995       |        统计特殊四元组        |                CountSpecialQuadruplets                 |
...
|       2022       |     将一维数组转变成二维数组      |               Convert1dArrayInto2dArray                |        数组         |
|       2047       |       句子中的有效单词数       |             NumberOfValidWordsInASentence              |                   |
|       2055       |        蜡烛之间的盘子        |                  PlatesBetweenCandles                  |      预处理,字符串      |                                        简单                                         |
|       2104       |        子数组范围和         |                  SumOfSubarrayRanges                   |       数组,暴力       |                                        简单                                         |
|       2114       |       句子中的最多单词数       |          MaximumNumberOfWordsFoundInSentences          |
|       2119       |        反转两次的数字        |              ANumberAfterADoubleReversal               |
|       2144       |      打折购买糖果的最小开销      |         MinimumCostOfBuyingCandiesWithDiscount         |
|       2169       |       得到 0 的操作数       |              CountOperationsToObtainZero               |        模拟         |
|       2236       |    判断根结点是否等于子结点之和     |                RootEqualsSumOfChildren                 |        模拟         |
|       2264       |    字符串中最大的 3 位相同数字    |            Largest3SameDigitNumberInString             |        字符串        |
|       2269       |     找到一个数字的 K 美丽值     |                FindTheKBeautyOfANumber                 |        数学         |
...
|       2520       |      统计能整除数字的位数       |            CountTheDigitsThatDivideANumber             |        桶排         |
|       2529       |     正整数和负整数的最大计数      |    MaximumCountOfPositiveIntegerAndNegativeInteger     |        二分         |
|       2535       |     数组元素和与数字和的绝对差     |    DifferenceBetweenElementSumAndDigitSumOfAnArray     |        模拟         |
|       2544       |         交替数字和         |                  AlternatingDigitSum                   |        模拟         |
|       2549       |      统计桌面上的不同数字       |              CountDistinctNumbersOnBoard               |        数学         |
|       2558       |      从数量最多的堆取走礼物      |              TakeGiftsFromTheRichestPile               |        大根堆        | PriorityQueue<Integer> maxheap = new PriorityQueue<>(Collections.reverseOrder()); |
|    面试题 02.06     |         回文链表          |                PalindromeLinkedListLcci                |
|    面试题 05.07     |         配对交换          |                      ExchangeLcci                      |        位运算        |
|    面试题 08.10     |         颜色填充          |                     ColorFillLcci                      |      深度优先搜索       |
|    面试题 10.01     |        合并排序的数组        |                    SortedMergeLcci                     |        数组         |
|    面试题 16.05     |         阶乘尾数          |                   FactorialZerosLcci                   |        数学         |
|    面试题 16.07     |         最大数值          |                      MaximumLcci                       |
|    面试题 16.11     |          跳水板          |                    DivingBoardLcci                     |        数学         |
|    面试题 16.15     |         珠玑妙算          |                     MasterMindLcci                     |        枚举         |
|    面试题 17.04     |         消失的数字         |                   MissingNumberLcci                    |        桶排         |
|    面试题 17.16     |          按摩师          |                    TheMasseuseLcci                     |       动态规划        |
|      面试题61       |        扑克牌中的顺子        |                BuKePaiZhongDeShunZiLcof                |        排序         |
|   剑指 Offer 05    |         替换空格          |                    TiHuanKongGeLcof                    |        jdk        |
|   剑指 Offer 09    |       用两个栈实现队列        |            YongLiangGeZhanShiXianDuiLieLcof            |      栈 Stack      |
|  剑指 Offer 10- I  |        斐波那契数列         |                  FeiBoNaQiShuLieLcof                   |       动态规划        |
| 剑指 Offer 10- II  |        青蛙跳台阶问题        |               QingWaTiaoTaiJieWenTiLcof                |       动态规划        |
|   剑指 Offer 17    |      打印从1到最大的n位数      |            DaYinCong1daoZuiDaDeNweiShuLcof             |        模拟         |
|   剑指 Offer 40    |        最小的k个数         |                  ZuiXiaoDeKgeShuLcof                   | 小根堆PriorityQueue  |
| 剑指 Offer 53 - I  |     在排序数组中查找数字 I      |           ZaiPaiXuShuZuZhongChaZhaoShuZiLcof           |        二分         |
|   剑指 Offer 54    |      二叉搜索树的第k大节点      |            ErChaSouSuoShuDeDiKdaJieDianLcof            |       二叉搜索树       |
| 剑指 Offer 55 - I  |        二叉树的深度         |                  ErChaShuDeShenDuLcof                  |       二叉树遍历       |
| 剑指 Offer 55 - II |         平衡二叉树         |                  PingHengErChaShuLcof                  |       二叉树遍历       |
|   剑指 Offer 57    |       和为s的两个数字        |                HeWeiSdeLiangGeShuZiLcof                |        二分         |
| 剑指 Offer 68 - II |      二叉树的最近公共祖先       |           ErChaShuDeZuiJinGongGongZuXianLcof           |        遍历树        |
|      LCP 01      |          猜数字          |                      GuessNumbers                      |        模拟         |
|      LCP 06      |          拿硬币          |                        NaYingBi                        |        模拟         |
|      LCP 17      |         速算机器人         |                         NGK0Fy                         |        模拟         |
