package editor.cn;//给你一个下标从 0 开始的数组 nums ，数组大小为 n ，且由 非负 整数组成。
//
...
//Java：|2460|对数组执行操作|ApplyOperationsToAnArray|
public class ApplyOperationsToAnArray{
    public static void main(String[] args) {
        Solution solution = new ApplyOperationsToAnArray().new Solution();
        // TO TEST
        for(int i : solution.applyOperations(new int[]{1,2,2,1,1,0})){
            System.out.print(i);
        }
    }
