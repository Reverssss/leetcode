package editor.cn;//给定一个正整数 n ，输出外观数列的第 n 项。
//
...
// 1 <= n <= 30 
// 
// Related Topics 字符串 👍 874 👎 0

//Java：|38|外观数列|CountAndSay|
...
class Solution {
    public String countAndSay(int n) {
        String ans = null;
        if( n > 1){
            ans = cutAndReplace(countAndSay(n-1));
        }if(n == 1){
            ans = "1";
        }
        return ans;
    ...
    public String cutAndReplace(String s){
        int num = 1 ;
