package editor.cn;//给你用户在 LeetCode 的操作日志，和一个整数 k 。日志用一个二维整数数组 logs 表示，其中每个 logs[i] = [IDi, timei]
...
// 
//
// Related Topics 数组 哈希表 👍 48 👎 0

import java.util.ArrayList;
import java.util.HashMap;
import java.util.HashSet;

//Java：|1817|查找用户活跃分钟数|FindingTheUsersActiveMinutes|
public class FindingTheUsersActiveMinutes{
    public static void main(String[] args) {
        Solution solution = new FindingTheUsersActiveMinutes().new Solution();
        // TO TEST
        solution.findingUsersActiveMinutes(new int[][]{{305589003,4136},{305589004,4139},{305589004,4141},{305589004,4137},{305589001,4139},{305589001,4139}},5);
    }
...
class Solution {
    public int[] findingUsersActiveMinutes(int[][] logs, int k) {
        ...
        for(int[] i : logs){
            HashSet set = map.getOrDefault(i[0],new HashSet());
            set.add(i[1]);
            map.put(i[0],set);
        }
