package editor.cn;//给你一个函数 f(x, y) 和一个目标结果 z，函数公式未知，请你计算方程 f(x,y) == z 所有可能的正整数 数对 x 和 y。满足条件的结果数对
//可以按任意顺序返回。 
//
...
// 
//
// Related Topics 数学 双指针 二分查找 交互 👍 68 👎 0

import java.util.ArrayList;
import java.util.List;

//Java：|1237|找出给定方程的正整数解|FindPositiveIntegerSolutionForAGivenEquation|
