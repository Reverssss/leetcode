package editor.cn;//某互联网公司一年一度的春招开始了，一共有 n 名面试者入选。每名面试者都会提交一份简历，公司会根据提供的简历资料产生一个预估的能力值，数值越大代表越有可能通
//过面试。 
//
...
// 
//
// Related Topics 数组 哈希表 数学 概率与统计 👍 34 👎 0

//Java：|LCP 11|期望个数统计|QiWangGeShuTongJi|
